    ...
    public class MirImageControl : MirControl
    {
        ...
        protected internal override void DrawControl()
        {
            ...
            if (DrawImage && Library != null)
            {
                ...
                {
                    //debug:
                    //CMain.SaveError($"子类MirImageControl.DrawControl()-SetGrayscale");
                ...
                {
                    //debug:
                    //CMain.SaveError($"子类MirImageControl.DrawControl()-DrawBlend");
                    Library.DrawBlend(Index, DisplayLocation, ForeColour, false, BlendingRate);
                }
                else
                {
                    //debug:
                    //CMain.SaveError($"子类MirImageControl.DrawControl()-Draw");

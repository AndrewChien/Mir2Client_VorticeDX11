    ...
    public sealed class MapControl : MirControl
    {
        ...
        private void DrawFloor()
        {
            if (DXManager.FloorTexture == null)
            {
                ...
                DXManager.FloorTexture = DXManager.NewTexture_RenderTarget_Default((uint)Settings.ScreenWidth, (uint)Settings.ScreenHeight);
        ...
        private void DrawLights(LightSetting setting)
        {
            ...
            if (DXManager.LightTexture == null)
            {
                ...
                //DXManager.LightTexture = DXManager.NewTexture((uint)Settings.ScreenWidth, (uint)Settings.ScreenHeight, 1, "RenderTarget", "Default");
                DXManager.LightTexture = DXManager.NewTexture_RenderTarget_Default((uint)Settings.ScreenWidth, (uint)Settings.ScreenHeight);
